...
export function usage(): never {
  ...
  node scripts/roku-live-test.ts flow-full <playback-content-id> <image-content-id> <audio-content-id> <subtitle-content-id> [media-type] [continue|beginning] [artifact-dir]
